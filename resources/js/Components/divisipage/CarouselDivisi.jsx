                    ...
                    <div className="flex flex-row justify-evenly">
                        ...
                        <div className="flex justify-center w-64 sm:w-96 penjelasan flex-col">
                            ...
                            <h2 className="text-xs sm:text-neutral lg:text-base text-wrap">
                                ...
                                yang memisahkan langit dan bumi.” BPH
                                bertanggung jawab untuk mendampingi, merangkul,
                                sekaligus memastikan agar kinerja dari seluruh
                                divisi UMN Festival 2023 dapat berjalan dengan
                                baik. Hal tersebut diumpamakan sebagai sosok
                                Atlas yang tengah mengangkat Sphere di
                                pundaknya.
                            </h2>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-row justify-evenly">
                        ...
                        <div className="flex justify-center w-64 sm:w-96 penjelasan flex-col">
                            ...
                            <h2 className="text-xs sm:text-neutral lg:text-base text-wrap">
                                ...
                                culpa pariatur, consectetur aliquam
