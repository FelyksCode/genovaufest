...
import UfestLogo from '/public/Images/UfestLogo.png'
  ...
  return (
    <Fade duration={2000}>
      <div className="h-[100vh] w-full flex justify-center items-center">
        ...
        <Fade bottom>
          <h1 className='font-custom absolute top-2/2 left-2/2 transform -translate-x-1/2 -translate-y-1/2 z-20 text-black text-4xl font-extrabold'
              onEnded={handleVideoEnd}
              style={{ opacity: videoOpacity }}>
