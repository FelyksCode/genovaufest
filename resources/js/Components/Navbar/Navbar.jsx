    ...
    <div className='shadow-md w-[95%] fixed top-2 left-3 md:left-8 z-10 rounded-full'>
        <div className="md:flex items-center justify-between bg-slate-100 py-4 md:px-10 px-7 rounded-full">
            <div className='font-bold text-2xl cursor-pointer flex items-center font-[Poppins text-gray-800] font-custom'>
                <span className='text-3xl text-gray-600 mr-4 pt-2'>
            ...
            <ul className={`rounded-3xl md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-slate-100 md:z-auto z-[-1] left-0 w-full md:w-auto md:px-0 px-[200px] transition-all duration-500 ease-in ${open ? 'top-[80px] opacity-100':'top-[-485px]'} md:opacity-100 opacity-0`}>
                {
                    Links.map((link)=>(
